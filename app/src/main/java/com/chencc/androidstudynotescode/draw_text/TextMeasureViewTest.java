...
public class TextMeasureViewTest extends View {
    ...
    public TextMeasureViewTest(final Context context) {
        super(context);
        init();
    }

    public TextMeasureViewTest(final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextMeasureViewTest(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public TextMeasureViewTest(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
