...
public class SlideCallbackD extends ItemTouchHelper.SimpleCallback {

    private RecyclerView mRv;
    private CardRecyclerAdapter adapter;
    private List<String> mDatas;

    public SlideCallbackD(RecyclerView mRv,
                          CardRecyclerAdapter adapter, List<String> mDatas) {
        super(0, 15);
        this.mRv = mRv;
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        String remove = mDatas.remove(viewHolder.getLayoutPosition());
        mDatas.add(0, remove);
